...
class Transform:
    ...
    The following parameters can be supplied with calling the transform object:
        joint [Bool]  -  If True then transform all samples in the list jointly using the same transformation.
                         Otherwise each sample will be transformed independently using
